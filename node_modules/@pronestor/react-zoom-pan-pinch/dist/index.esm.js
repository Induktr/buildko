import React, { Component, useContext, useRef, useEffect, useState, useImperativeHandle } from 'react';
...
var contextInitialState = __assign(__assign({}, initialState), { contextInstance: null, setComponents: function () { return undefined; } });
var initialSetup = {
    centerOnInit: false,
...
function handlePanToBounds(contextInstance) {
    ...
    var mousePosX = positionX > maxPositionX
        ...
        : (_a = contextInstance.setup.minPositionX) !== null && _a !== void 0 ? _a : 0;
    var mousePosY = positionY > maxPositionY
        ? wrapperComponent.offsetHeight
        : (_b = contextInstance.setup.minPositionY) !== null && _b !== void 0 ? _b : 0;
...
function handleAlignToScaleBounds(contextInstance, mousePositionX, mousePositionY) {
    ...
    var mouseX = mousePositionX === undefined || mousePositionX === 0
        ? wrapperComponent.offsetWidth / 2
        : mousePositionX;
    var mouseY = mousePositionY === undefined || mousePositionY === 0
...
var centerView = function (contextInstance) {
    return function (scale, animationTime, animationType) {
        ...
        if (wrapperComponent !== null && contentComponent !== null) {
            var targetState = getCenterPosition(scale === undefined || scale === 0 ? transformState.scale : scale, wrapperComponent, contentComponent);
            animate(contextInstance, targetState, animationTime, animationType);
        }
    };
};
...
var isExcludedNode = function (node, excludedTagsOrClassNames) {
    ...
    var isExcludedTag = excludedTagsOrClassNames.some(function (tag) { return tag.toUpperCase() === targetTagName; });
    if (isExcludedTag) {
        return true;
    }
...
var handleWheelZoomStop = function (contextInstance, event) {
    ...
    if (previousWheelEvent.deltaY > 0 &&
...
var TransformContext = /** @class */ (function (_super) {
    ...
    function TransformContext() {
        ...
        _this.onTouchPanningStart = function (event) {
            ...
            var isDoubleTap = _this.lastTouch !== null && new Date().valueOf() - _this.lastTouch < 200;
            if (isDoubleTap && event.touches.length === 1) {
                _this.onDoubleClick(event);
            }
            else {
                _this.lastTouch = new Date().valueOf();
                handleCancelAnimation(_this);
                var touches = event.touches;
        ...
        _this.isPressingKeys = function (keys) {
            ...
            return keys.some(function (key) { return _this.pressedKeys[key]; });
        };
...
var TransformComponent = function (_a) {
    ...
    return (React.createElement("div", { ref: wrapperRef, className: "react-transform-wrapper ".concat(styles.wrapper, " ").concat(wrapperClass), style: wrapperStyle },
        React.createElement("div", { ref: contentRef, className: "react-transform-component ".concat(styles.content, " ").concat(contentClass), style: contentStyle }, children)));
};
