...
// node_modules/@pronestor/react-zoom-pan-pinch/dist/index.esm.js
...
var css_248z = ".transform-component-module_content__uCDPE {\n  display: flex;\n  flex-wrap: wrap;\n  height: -moz-fit-content;\n  height: fit-content;\n  margin: 0;\n  padding: 0;\n  transform-origin: 0% 0%;\n  width: -moz-fit-content;\n  width: fit-content;\n}\n\n.transform-component-module_content__uCDPE img {\n  pointer-events: none;\n}\n\n.transform-component-module_wrapper__7HFJe {\n  height: -moz-fit-content;\n  height: fit-content;\n  margin: 0;\n  overflow: hidden;\n  padding: 0;\n  position: relative;\n  -khtml-user-select: none;\n  -moz-user-select: none;\n  -ms-user-select: none;\n  -webkit-touch-callout: none;\n  -webkit-user-select: none;\n  user-select: none;\n  width: -moz-fit-content;\n  width: fit-content;\n}\n";
var styles = { "content": "transform-component-module_content__uCDPE", "wrapper": "transform-component-module_wrapper__7HFJe" };
...
var contextInitialState = __assign(__assign({}, initialState), { contextInstance: null, setComponents: function() {
  return void 0;
} });
var initialSetup = {
  centerOnInit: false,
...
var isPanningStartAllowed = function(contextInstance, event) {
  ...
  var isWrapperChild = (_a = wrapperComponent === null || wrapperComponent === void 0 ? void 0 : wrapperComponent.contains(target)) !== null && _a !== void 0 ? _a : false;
  var isAllowed = isInitialized && target !== null && isWrapperChild;
  if (!isAllowed) {
    return false;
  }
...
function handlePanToBounds(contextInstance) {
  var _a, _b;
  var _c = contextInstance.transformState, positionX = _c.positionX, positionY = _c.positionY, scale = _c.scale;
  var _d = contextInstance.setup, disabled = _d.disabled, limitToBounds = _d.limitToBounds, centerZoomedOut = _d.centerZoomedOut;
  var wrapperComponent = contextInstance.wrapperComponent;
  if (disabled || wrapperComponent === null || contextInstance.bounds === null) {
    return;
  }
  var _e = contextInstance.bounds, maxPositionX = _e.maxPositionX, minPositionX = _e.minPositionX, maxPositionY = _e.maxPositionY, minPositionY = _e.minPositionY;
  var xChanged = positionX > maxPositionX || positionX < minPositionX;
  var yChanged = positionY > maxPositionY || positionY < minPositionY;
  var mousePosX = positionX > maxPositionX ? wrapperComponent.offsetWidth : (_a = contextInstance.setup.minPositionX) !== null && _a !== void 0 ? _a : 0;
  var mousePosY = positionY > maxPositionY ? wrapperComponent.offsetHeight : (_b = contextInstance.setup.minPositionY) !== null && _b !== void 0 ? _b : 0;
  var _f = handleCalculateZoomPositions(contextInstance, mousePosX, mousePosY, scale, contextInstance.bounds, limitToBounds || centerZoomedOut), x = _f.x, y = _f.y;
  return {
    scale,
...
function handleCalculateVelocity(contextInstance, position) {
  ...
  var now = Date.now();
  if (lastMousePosition !== null && velocityTime !== null && velocityTime !== 0 && wrapperComponent !== null) {
...
function handleVelocityPanning(contextInstance) {
  ...
  if (!isAllowed || velocity === null || bounds === null || wrapperComponent === null) {
    return;
  }
...
function handlePanningEnd(contextInstance) {
  ...
  if (contextInstance.isPanning) {
    ...
    var wrapperWidth = (_a = wrapperRect === null || wrapperRect === void 0 ? void 0 : wrapperRect.width) !== null && _a !== void 0 ? _a : 0;
    var wrapperHeight = (_b = wrapperRect === null || wrapperRect === void 0 ? void 0 : wrapperRect.height) !== null && _b !== void 0 ? _b : 0;
    var contentWidth = (_c = contentRect === null || contentRect === void 0 ? void 0 : contentRect.width) !== null && _c !== void 0 ? _c : 0;
    var contentHeight = (_d = contentRect === null || contentRect === void 0 ? void 0 : contentRect.height) !== null && _d !== void 0 ? _d : 0;
    var isZoomed = wrapperWidth < contentWidth || wrapperHeight < contentHeight;
    var shouldAnimate = !velocityDisabled && velocity !== null && velocity.total > 0.1 && isZoomed;
    if (shouldAnimate) {
...
function handleAlignToBounds(contextInstance) {
  ...
  var isDisabled = disabled || scale < minScale || sizeX === 0 && sizeY === 0;
  if (isDisabled) {
    return;
  }
...
function handleAlignToScaleBounds(contextInstance, mousePositionX, mousePositionY) {
  ...
  var mouseX = mousePositionX === void 0 || mousePositionX === 0 ? wrapperComponent.offsetWidth / 2 : mousePositionX;
  var mouseY = mousePositionY === void 0 || mousePositionY === 0 ? wrapperComponent.offsetHeight / 2 : mousePositionY;
...
function calculateZoomToNode(contextInstance, node, customZoom) {
  ...
  var newScale = checkZoomBounds(customZoom !== null && customZoom !== void 0 ? customZoom : Math.min(scaleX, scaleY), minScale, maxScale, 0, false);
...
function isValidZoomNode(node) {
  ...
  if (typeof node !== "object" || !("offsetWidth" in node) && !("offsetHeight" in node)) {
...
var centerView = function(contextInstance) {
  return function(scale, animationTime, animationType) {
    ...
    if (wrapperComponent !== null && contentComponent !== null) {
      var targetState = getCenterPosition(scale === void 0 || scale === 0 ? transformState.scale : scale, wrapperComponent, contentComponent);
      animate(contextInstance, targetState, animationTime, animationType);
    }
  };
};
var zoomToElement = function(contextInstance) {
  return function(node, scale, animationTime, animationType) {
    ...
    if (wrapperComponent !== null && isValidZoomNode(target) && target !== null && wrapperComponent.contains(target)) {
...
var isExcludedNode = function(node, excludedTagsOrClassNames) {
  var targetTagName = node.tagName.toUpperCase();
  var isExcludedTag = excludedTagsOrClassNames.some(function(tag) {
    return tag.toUpperCase() === targetTagName;
  });
  if (isExcludedTag) {
    return true;
  }
  var containsExcludedCssClass = excludedTagsOrClassNames.some(function(className) {
...
var getTransformStyles = function(x, y, scale) {
  return "matrix(".concat(scale, ", 0,0, ").concat(scale, ", ").concat(x, ", ").concat(y, ")");
};
...
var isWheelAllowed = function(contextInstance, event) {
  ...
  var target = event.target;
  var isAllowed = isInitialized && !isPanning && !disabled && target !== null;
  if (!isAllowed) {
    return false;
  }
...
var isDoubleClickAllowed = function(contextInstance, event) {
  ...
  var _b = setup.doubleClick, disabled = _b.disabled, excluded = _b.excluded;
  var target = event.target;
  var isWrapperChild = (_a = wrapperComponent === null || wrapperComponent === void 0 ? void 0 : wrapperComponent.contains(target)) !== null && _a !== void 0 ? _a : false;
  var isAllowed = isInitialized && target !== null && isWrapperChild && !disabled;
  if (!isAllowed) {
    return false;
  }
  var isExcluded = isExcludedNode(target, excluded);
...
var isPinchStartAllowed = function(contextInstance, event) {
  ...
  var target = event.target;
  var isAllowed = isInitialized && !disabled && target !== null;
  if (!isAllowed) {
    return false;
  }
  var isExcluded = isExcludedNode(target, excluded);
...
var isPinchAllowed = function(contextInstance) {
  ...
  var isAllowed = isInitialized && !disabled && pinchStartDistance !== null && pinchStartDistance !== 0;
  if (!isAllowed) {
    return false;
  }
  return true;
...
var calculatePinchZoom = function(contextInstance, currentDistance) {
  ...
  var maxScale = setup.maxScale, minScale = setup.minScale, zoomAnimation = setup.zoomAnimation;
  var size = zoomAnimation.size, disabled = zoomAnimation.disabled;
  if (pinchStartScale === null || pinchStartScale === 0 || pinchStartDistance === null || pinchStartDistance === 0 || currentDistance === 0) {
...
var Context = import_react.default.createContext(contextInitialState);
  ...
  function(_super) {
    ...
    function TransformContext2() {
      ...
      _this.onPinchStop = function(event) {
        ...
        if (_this.pinchStartScale !== null && _this.pinchStartScale !== 0) {
      ...
      _this.onTouchPanningStart = function(event) {
        ...
        var isDoubleTap = _this.lastTouch !== null && (/* @__PURE__ */ new Date()).valueOf() - _this.lastTouch < 200;
        if (isDoubleTap && event.touches.length === 1) {
          _this.onDoubleClick(event);
        } else {
          _this.lastTouch = (/* @__PURE__ */ new Date()).valueOf();
          handleCancelAnimation(_this);
          var touches = event.touches;
      ...
      _this.setCenter = function() {
        if (_this.wrapperComponent !== null && _this.contentComponent !== null) {
          var targetState = getCenterPosition(_this.transformState.scale, _this.wrapperComponent, _this.contentComponent);
          _this.setTransformState(targetState.scale, targetState.positionX, targetState.positionY);
        }
      };
      _this.applyTransformation = function() {
        if (!_this.mounted || _this.contentComponent === null) {
          return;
        }
    ...
    TransformContext2.prototype.render = function() {
      ...
      return import_react.default.createElement(Context.Provider, { value: __assign(__assign({}, this.transformState), { setComponents: this.setComponents, contextInstance: this }) }, content);
    };
...
var TransformComponent = function(_a) {
  ...
  var setComponents = (0, import_react.useContext)(Context).setComponents;
  ...
  return import_react.default.createElement(
    "div",
    { ref: wrapperRef, className: "react-transform-wrapper ".concat(styles.wrapper, " ").concat(wrapperClass), style: wrapperStyle },
    import_react.default.createElement("div", { ref: contentRef, className: "react-transform-component ".concat(styles.content, " ").concat(contentClass), style: contentStyle }, children)
  );
};
var TransformWrapper = import_react.default.forwardRef(function(props, ref) {
  var _a = (0, import_react.useState)(null), innerRef = _a[0], setRef = _a[1];
  (0, import_react.useImperativeHandle)(ref, function() {
    return innerRef;
  }, [innerRef]);
  return import_react.default.createElement(TransformContext, __assign({}, props, { setRef }));
});
...
//# sourceMappingURL=@pronestor_react-zoom-pan-pinch.js.map
